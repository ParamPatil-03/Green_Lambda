        ...
        new Chart(energyCtx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Predicted',
                        data: [1.32, 2.85, 2.41, 1.45, 3.46, 0.89, 1.14],
                        borderColor: '#c8ff00',
                    ...
                    {
                        label: 'Actual',
                        data: [1.45, 2.70, 2.65, 1.30, 3.82, 0.95, 1.35],
                        borderColor: '#7b61ff',
                    ...
                    {
                        label: 'Optimized',
                        data: [0.94, 1.88, 1.90, 0.86, 2.14, 0.61, 0.85],
                        borderColor: '#36f9ae',
    ...
    if (radarCtx) {
        new Chart(radarCtx, {
            ...
            data: {
                ...
                datasets: [
                    { label: 'XGBoost', data: [93.8, 94.2, 91.5, 89.8, 92.1, 85.0], borderColor: '#c8ff00', backgroundColor: 'rgba(200,255,0,0.06)', borderWidth: 2, pointRadius: 3, pointBackgroundColor: '#c8ff00' },
                    { label: 'Random Forest', data: [91.2, 90.5, 92.1, 88.9, 86.5, 82.1], borderColor: '#36f9ae', backgroundColor: 'rgba(54,249,174,0.04)', borderWidth: 2, pointRadius: 3, pointBackgroundColor: '#36f9ae' },
