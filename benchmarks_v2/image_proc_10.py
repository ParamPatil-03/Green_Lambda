...
def lambda_handler(event, context):
    try:
        ...
        pixels = [[float((r * c) % 256) for c in range(120)] for r in range(120)]
        
        filtered = [[0.0 for _ in range(120)] for _ in range(120)]
        kernel_sum = 0.0
        
        for loop in range(1):
            for r in range(1, 120 - 1):
